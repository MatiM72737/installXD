...
paru -S firefox oh-my-posh-bin libxcrypt-compat imagemagick cpupower perl fuse2 aylurs-gtk-shell-git lib32-libcups meson vala valadoc gobject-introspection gtk-layer-shell libastal-git jq bibata-cursor-theme-bin ttf-meslo-nerd ttf-meslo-nerd-font-powerlevel10k socat qt6ct kvantum cups brother-dcpj105 swww btop imv vlc ventoy-bin pwvucontrol yabridge yabridgectl downgrade egl-wayland vesktop-bin ayugram-desktop-bin pipewire pipewire-alsa pipewire-jack pipewire-pulse wireplumber nautilus-admin-gtk4 qpwgraph nautilus nautilus-empty-file nautilus-gnome-disks nautilus-mediainfo-gtk4 nwg-look ghostty code wget curl fish nvidia nvidia-utils lib32-nvidia-utils nvidia-settings gtk4 gtk3 ninja gcc cmake meson libxcb xcb-proto xcb-util xcb-util-keysyms libxfixes libx11 libxcomposite libxrender libxcursor pixman wayland-protocols cairo pango libxkbcommon xcb-util-wm xorg-xwayland libinput libliftoff libdisplay-info cpio tomlplusplus hyprlang-git hyprcursor-git hyprwayland-scanner-git xcb-util-errors hyprutils-git glaze hyprgraphics-git aquamarine-git re2 hyprland-qtutils aquamarine hyprpolkitagent qbittorrent wl-clip-persist wl-clipboard sweet-gtk-theme-git sweet-folders-icons-git hyprlock hypridle hyprpicker obs-studio xdg-desktop-portal xdg-desktop-portal-hyprland xdg-desktop-portal-gtk stow fastfetch hyprsunset hyprlang hyprcursor hyprutils hyprgraphics hyprwayland-scanner --needed
